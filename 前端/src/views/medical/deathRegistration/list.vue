<template>
  <div class="app-container">
    ...
    <div class="tools-div">
      <el-form :inline="true" :model="queryParams">
        ...
        <el-form-item>
          ...
          <el-button size="small" type="success" @click="saveDish">新增死亡记录</el-button>
        </el-form-item>
      </el-form>

      <el-table
        :data="dataList.deathRegistrationRoList"
        border
        size="mini"
      ...
      >
        ...
        <el-table-column prop="deathDate" header-align="center" align="center" label="死亡登记日期"/>
        <el-table-column prop="deathTime" header-align="center" align="center" label="死亡详细时间"/>
        <el-table-column prop="registrarName" header-align="center" :show-overflow-tooltip="true" align="center" label="登记人"/>
        ...
        <el-table-column prop="isSettled" header-align="center" :show-overflow-tooltip="true" align="center" label="是否结算"/>
        <el-table-column prop="confirmingDoctorName" header-align="center" align="center" label="确认医生"/>
        <el-table-column prop="confirmingDoctorPosition" header-align="center" align="center" label="确认医生职位"/>
        <el-table-column prop="causeOfDeath" header-align="center" align="center" label="死亡原因"/>
        ...
        >
          <template slot-scope="scope">
            <el-button v-if="scope.row.isSettled == '否'" type="text" size="small" @click="changeIsSettled(scope.row.id)">一键结算</el-button>
            <el-button type="text" size="small" @click="details(scope.row)">病案详情</el-button>
            <el-button v-if="scope.row.fileUrl == null" type="text" size="small" @click="uploadFile(scope.row)">上传病案
            </el-button>
    ...
    <el-dialog title="新增死亡登记" :visible.sync="dialogFormVisible" width="70%">
      <!-- 工具条 -->
      <div class="tools-div">
        ...
        >
          ...
          <el-table-column prop="identificationNumber" header-align="center" :show-overflow-tooltip="true" align="center" label="身份证号"/>
          <el-table-column prop="contactNumber" header-align="center" align="center" label="联系电话"/>
          <el-table-column prop="insuranceType" header-align="center" align="center" label="医保类型" />
          <el-table-column prop="insuranceNumber" header-align="center" :show-overflow-tooltip="true" align="center" label="医保号"/>
      ...
      <div class="tools-div">
        <el-descriptions class="margin-top" :column="3" border>
          <el-descriptions-item>
            ...
            <el-date-picker
              v-model="deathRegistration.deathTime"
              size="small"
              type="datetime"
          ...
          <el-descriptions-item>
            ...
            <el-input size="small" v-model="deathRegistration.registrarPosition" class="custom-input"
          ...
          <el-descriptions-item>
            ...
            <el-input-number size="small" v-model="deathRegistration.costCalculation" step="0.1" style="width: 200px"
          ...
          <el-descriptions-item>
            ...
            <el-select v-model="deathRegistration.isSettled" size="small" clearable placeholder="请选择" style="width: 200px">
          ...
          <el-descriptions-item>
            ...
            <el-select v-model="deathRegistration.confirmingDoctorName" size="small" clearable placeholder="请选择" style="width: 200px">
              <el-option
          ...
          <el-descriptions-item>
            ...
            <el-input size="small" v-model="deathRegistration.confirmingDoctorPosition" class="custom-input"
                      placeholder="确认医生职位" clearable
            ></el-input>
          </el-descriptions-item>
          <el-descriptions-item span="3">
            ...
            <el-input
              ...
              :rows="5"
              placeholder="请输入内容"
              v-model="deathRegistration.causeOfDeath">
            </el-input>
          </el-descriptions-item>
        </el-descriptions>
      </div>
...
import deathRegistrationApi from '@/api/medical/deathRegistration'
...
export default {
  ...
  created() {
    this.getDepList()
    this.getDataList()
    this.findAllDoctorInfo()
  },

  methods: {
    findAllDoctorInfo() {
      doctorApi.getAllDoctorInfo()
      .then(res => {
    ...
    getDataList(page = 1) {
      ...
      deathRegistrationApi.findList(this.queryParams)
        .then(res => {
          console.log(res)
    ...
    submitDish(){
      ...
      this.deathRegistration.admissionRegistrationId = this.dataListSelections[0].id
      deathRegistrationApi.saveDisch(this.deathRegistration)
      .then(res => {
    ...
    saveOrUpdate() {
      deathRegistrationApi.upload(this.medicalFile)
        .then(res => {
          // 提示成功
