<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column align="center" prop="phone" width="115" label="手机"/>
  ...
  methods: {
    ...
    edit(id) {
      ...
      api.getById(id).then(response => {
        ...
        if (this.sysUser.headUrl != '' || this.sysUser.headUrl != null) {
          this.fileList = []
          this.fileList.push({
            name: this.sysUser.headUrl.substr(this.sysUser.headUrl.lastIndexOf('/') + 1),
    ...
    */
    ...
    handleAvatarSuccess(res, file) {
      ...
      if (this.fileList.length > 0 && (this.sysUser.headUrl != null || this.sysUser.headUrl != '')) {
        // 先删除以前的图片
        this.deleteFile(this.sysUser.headUrl)
        this.fileList = []
      }
      this.fileList.push(
        {
